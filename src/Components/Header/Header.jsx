    ...
    return (
        <nav className="nav none-visible">
            ...
            <div className="nav-content">
                <ul className="nav-content-ul" style={{'--length': 4}}>
                    <li className="nav-content-li" style={{'--delay': 3}} data-scrolly='from-left'><Link to="/"><h2>Homepage</h2></Link></li>
                    <li className="nav-content-li" style={{'--delay': 2}} data-scrolly='from-left'><Link to="/heroes"><h2>Heroes</h2></Link></li>
                    <li className="nav-content-li" style={{'--delay': 1}} data-scrolly='from-left'><Link to="/items"><h2>Items</h2></Link></li>
                    <li className="nav-content-li" style={{'--delay': 0}} data-scrolly='from-left'><Link to="/guide"><h2>Guide</h2></Link></li>
                </ul>
                <hr className="separator" style={{'--delay': 4}} data-scrolly='from-left'/>
                <div className="nav-content-policy">
                    <Link to={'/privacy-policy'} style={{'--delay': 5}} data-scrolly='from-left'><p className='p-s'>Privacy Policy</p></Link>
                    <Link to={'/terms-of-services'} style={{'--delay': 6}} data-scrolly='from-left'><p className='p-s'>Terms of Services</p></Link>
                </div>
            </div>
            </div>
        </nav>
